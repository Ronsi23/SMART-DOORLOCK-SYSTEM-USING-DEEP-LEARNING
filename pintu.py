...
class IntegratedVerificationSystem:
    def __init__(self):
        ...
        try:
            ...
            print("✅ Relay GPIO 17 diinisialisasi dengan sysfs")
            print("✅ Wiring: Raspi 5V→Relay VCC, Raspi GND→Relay GND, GPIO17→Relay IN")
    ...
    def activate_relay(self):
        ...
        try:
            if self.gpio_controller:
                ...
                # Tahan solenoid aktif selama 3 detik
                time.sleep(10)
                ...
                print("🔓 [SIMULASI] Solenoid aktif selama 3 detik")
                time.sleep(10)
            ...
            # TAHAP 4: VERIFYING_ACTION
                ...
                if detected_action == self.current_command:
                    ...
                    if self.action_stable_count >= 5:  # 5 frame konsisten
                        ...
                        self.activate_relay()  # Gunakan method yang sudah diperbaiki
    ...
    def run_verification(self):
        ...
        print("🚀 MEMULAI SISTEM DOOR LOCK")
